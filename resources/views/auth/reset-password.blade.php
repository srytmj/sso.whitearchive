        ...
        <div class="space-y-5">
            <div>
                ...
                <input type="email" value="{{ $email }}" disabled
                    class="input input-bordered w-full text-base-content/40 bg-base-200 cursor-not-allowed" />
            </div>

            <div>
                <label class="block text-sm font-medium text-base-content/70 mb-1">{{ __('auth.new_password') }}</label>
            ...
            <button type="submit" class="btn btn-neutral w-full active:scale-95">{{ __('auth.reset_password_button') }}</button>
        </div>
    </form>
@endsection
