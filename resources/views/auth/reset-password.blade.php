...
@section('content')
    ...
    <form method="POST" action="{{ route('password.update') }}" novalidate>
        ...
        <div class="space-y-5">
            ...
            <button type="submit" class="w-full inline-flex items-center justify-center px-4 py-2 bg-zinc-900 text-white text-sm font-medium rounded-lg hover:bg-zinc-800 transition-colors">Reset Password</button>
        </div>
    </form>
@endsection
