        ...
        <div class="flex flex-col sm:flex-row gap-3">
            ...
            <div x-data="{
                ...
                <button type="button" @click="open = !open"
                    ...
                    <svg class="w-4 h-4 text-zinc-400 shrink-0 transition-transform duration-150" :class="open ? 'rotate-180' : ''" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
