...
return [
    'title' => 'アプリケーション',
    'add_button' => 'アプリケーションを追加',
    'th_name' => '名前',
    'th_client_id' => 'クライアントID',
    'th_created' => '作成日',
    'detail' => '詳細',
    'delete' => '削除',
    ...
    'auth_url_label' => '認可URLの例',
    'auth_url_hint' => ':placeholder をアプリのPKCEフローで生成したcode challengeに置き換えてください。',
    'copy' => 'コピー',
    'copied' => 'コピーしました！',
